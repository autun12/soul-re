...
DebugMenuLine standardMenu[] = {
    ...
    {DEBUG_LINE_TYPE_BIT, 0, 0, "keep info between loads",
     &gameTrackerX.streamFlags, 0x200000},
    {DEBUG_LINE_TYPE_MENU, 0, 0, "LEVELS", (long *)levelSelectMenu, 0},
    {DEBUG_LINE_TYPE_BIT, 0, 0, "SHORT SHORT STATS", &gameTrackerX.debugFlags,
     0x04000000},
    {DEBUG_LINE_TYPE_MENU, 0, 0, "RAZIEL MENU...", (long *)debugRazielMenu, 0},
    {DEBUG_LINE_TYPE_MENU, 0, 0, "CAMERA MENU...", (long *)cameraMenu, 0},
    {DEBUG_LINE_TYPE_MENU, 0, 0, "FOG MENU...", (long *)fogMenu,
     (intptr_t)DEBUG_FogLoad},
    {DEBUG_LINE_TYPE_ACTION, 0, 0, "VIEW VRAM", (long *)DEBUG_SetViewVram, 0},
    {DEBUG_LINE_TYPE_BIT, 0, 0, "Show Warp Gate Info",
     &gameTrackerX.debugFlags2, 0x01000000},
    {DEBUG_LINE_TYPE_BIT, 0, 0, "Activate All WarpGates",
...
DebugMenuLine saveMenu[] = {
    ...
    {DEBUG_LINE_TYPE_ACTION, 0, 0, "Save Current Game",
     (long *)SAVE_DebugSaveGame, 0},
    {DEBUG_LINE_TYPE_ACTION, 0, 0, "Restore Game", (long *)SAVE_LoadSaveGame,
     0},
    {DEBUG_LINE_TYPE_ENDLIST, 0, 0, "", &gameTrackerX.debugFlags, 0},
};
DebugMenuLine eventMenu[] = {
    {DEBUG_LINE_TYPE_MENU, 0, 0, "MAIN MENU...", (long *)standardMenu, 0},
    {DEBUG_LINE_TYPE_BIT, 0, 0, "Show Event Vars", &gameTrackerX.debugFlags,
     0x40000000},
    {DEBUG_LINE_TYPE_BIT, 0, 0, "SHOW EVENT DEBUG", &gameTrackerX.debugFlags2,
     0x100},
    {DEBUG_LINE_TYPE_BIT, 0, 0, "SHOW Spline Info", &gameTrackerX.debugFlags2,
     0x400000},
    {DEBUG_LINE_TYPE_BIT, 0, 0, "SHOW GAME TIME", &gameTrackerX.debugFlags2,
     0x10000},
    {DEBUG_LINE_TYPE_LONG, 0, 0x4000, "GAME TIME MULT",
     &gameTrackerX.multGameTime, (intptr_t)DEBUG_KeepGameTime},
    {DEBUG_LINE_TYPE_LONG, 0, 0x960, "SET GAME TIME", &debugGameTime,
     (intptr_t)DEBUG_SetGameTime},
    {DEBUG_LINE_TYPE_BIT, 0, 0, "Show Warp Gate Info",
     &gameTrackerX.debugFlags2, 0x01000000},
    {DEBUG_LINE_TYPE_BIT, 0, 0, "Activate All WarpGates",
     &gameTrackerX.streamFlags, 0x400000},
...
DebugMenuLine fogMenu[] = {
    {DEBUG_LINE_TYPE_MENU, 0, 0, "MAIN MENU...", (long *)standardMenu, 0},
    {DEBUG_LINE_TYPE_LONG, -1, 0x2CEC, "FOG FAR", &debugFogFar,
     (intptr_t)DEBUG_UpdateFog},
    {DEBUG_LINE_TYPE_LONG, -1, 0x2CEC, "FOG NEAR", &debugFogNear,
     (intptr_t)DEBUG_UpdateFog},
    {DEBUG_LINE_TYPE_LONG, 0, 0xFF, "FOG RED", &debugFogRed,
     (intptr_t)DEBUG_UpdateFog},
    {DEBUG_LINE_TYPE_LONG, 0, 0xFF, "FOG GREEN", &debugFogGrn,
     (intptr_t)DEBUG_UpdateFog},
    {DEBUG_LINE_TYPE_LONG, 0, 0xFF, "FOG BLUE", &debugFogBlu,
     (intptr_t)DEBUG_UpdateFog},
...
DebugMenuLine goodiesMenu[] = {
    ...
    {DEBUG_LINE_TYPE_LONG, 0, 2, "FRAME RATE LOCK", &gameTrackerX.frameRateLock,
     0},
    {DEBUG_LINE_TYPE_BIT, 0, 0, "IGNORE OBJECT SCRIPTS",
     &gameTrackerX.debugFlags, 0x10},
    {DEBUG_LINE_TYPE_BIT, 0, 0, "C CODE", &gameTrackerX.debugFlags, 0x800},
    {DEBUG_LINE_TYPE_BIT, 0, 0, "STOP ACTION", &gameTrackerX.debugFlags,
     0x200000},
    {DEBUG_LINE_TYPE_ACTION, 0, 0, "VIEW VRAM", (long *)DEBUG_SetViewVram, 0},
    {DEBUG_LINE_TYPE_BIT, 0, 0, "CAPTURE SCREEN", &gameTrackerX.debugFlags,
     0x4000},
    {DEBUG_LINE_TYPE_BIT, 0, 0, "SIGNAL STATS", &gameTrackerX.debugFlags,
     0x800000},
    {DEBUG_LINE_TYPE_BIT, 0, 0, "SIGNAL LOGIC VALUES", &gameTrackerX.debugFlags,
     0x01000000},
    {DEBUG_LINE_TYPE_BIT, 0, 0, "NO OPTIONAL SIGNALS", &gameTrackerX.gameFlags,
     0x40},
    {DEBUG_LINE_TYPE_BIT, 0, 0, "VV STATS", &gameTrackerX.debugFlags,
     0x02000000},
    {DEBUG_LINE_TYPE_BIT, 0, 0, "VOICE ON", &gameTrackerX.debugFlags, 0x80000},
    {DEBUG_LINE_TYPE_BIT, 0, 0, "SHOW MUSIC VARS", &gameTrackerX.debugFlags,
     0x10000000},
    {DEBUG_LINE_TYPE_ENDLIST, 0, 0, "", &gameTrackerX.debugFlags, 0},
};
DebugMenuLine debugRazielMenu[] = {
    {DEBUG_LINE_TYPE_MENU, 0, 0, "MAIN MENU...", (long *)standardMenu, 0},
    {DEBUG_LINE_TYPE_MENU, 0, 0, "HEALTH SYSTEM    ...",
     (long *)debugHealthSystemMenu, 0},
    {DEBUG_LINE_TYPE_MENU, 0, 0, "Special Abilities...",
     (long *)debugSpecialAbilitiesMenu, 0},
    {DEBUG_LINE_TYPE_MENU, 0, 0, "Forged  Abilities...",
     (long *)debugForgedAbilitiesMenu, 0},
    {DEBUG_LINE_TYPE_MENU, 0, 0, "Glyph   Abilities...",
     (long *)debugGlyphAbilitiesMenu, 0},
    {DEBUG_LINE_TYPE_MENU, 0, 0, "IMBUE SOUL REAVER...",
     (long *)debugImbueSoulReaverMenu, 0},
    {DEBUG_LINE_TYPE_BIT, 0, 0, "SHIFT ANY TIME", (long *)&debugRazielFlags1,
     0x50},
    {DEBUG_LINE_TYPE_ENDLIST, 0, 0, "", &gameTrackerX.debugFlags, 0},
};
DebugMenuLine debugHealthSystemMenu[] = {
    {DEBUG_LINE_TYPE_MENU, 0, 0, "MAIN MENU...", (long *)standardMenu, 0},
    {DEBUG_LINE_TYPE_MENU, 0, 0, "RAZIEL MENU...", (long *)debugRazielMenu, 0},
    {DEBUG_LINE_TYPE_LONG, 1, 4, "HEALTH LEVEL", &debugHealthLevel,
     (intptr_t)DEBUG_UpdateHealth},
    {DEBUG_LINE_TYPE_LONG, 1, 6, "MANA LEVEL", &debugManaLevel,
     (intptr_t)DEBUG_UpdateMana},
    {DEBUG_LINE_TYPE_BIT, 0, 0, "INVINCIBLE", &gameTrackerX.debugFlags2,
     0x100000},
    {DEBUG_LINE_TYPE_ACTION, 0, 0, "HURT RAZIEL",
     (long *)RAZIEL_DebugHurtRaziel, 0},
    {DEBUG_LINE_TYPE_ENDLIST, 0, 0, "", &gameTrackerX.debugFlags, 0},
};
DebugMenuLine debugSpecialAbilitiesMenu[] = {
    {DEBUG_LINE_TYPE_MENU, 0, 0, "MAIN MENU...", (long *)standardMenu, 0},
    ...
    {DEBUG_LINE_TYPE_BIT, 0, 0, "PASS THROUGH BARRIERS",
     (long *)&debugRazielFlags1, 1},
    {DEBUG_LINE_TYPE_BIT, 0, 0, "WALL CRAWLING", (long *)&debugRazielFlags1,
     0xB},
...
DebugMenuLine debugForgedAbilitiesMenu[] = {
    ...
    {DEBUG_LINE_TYPE_BIT, 0, 0, "Spectral Reaver", (long *)&debugRazielFlags1,
     0x400},
    {DEBUG_LINE_TYPE_BIT, 0, 0, "Material Reaver", (long *)&debugRazielFlags1,
     0x800},
    {DEBUG_LINE_TYPE_BIT, 0, 0, "Fire Reaver", (long *)&debugRazielFlags1,
     0x8000},
    {DEBUG_LINE_TYPE_ENDLIST, 0, 0, "", &gameTrackerX.debugFlags, 0},
};
DebugMenuLine debugGlyphAbilitiesMenu[] = {
    ...
    {DEBUG_LINE_TYPE_BIT, 0, 0, "Sunlight Glyph", (long *)&debugRazielFlags1,
     0x400000},
    {DEBUG_LINE_TYPE_BIT, 0, 0, "Water Glyph", (long *)&debugRazielFlags1,
     0x200000},
    {DEBUG_LINE_TYPE_BIT, 0, 0, "Fire Glyph", (long *)&debugRazielFlags1,
     0x800000},
    {DEBUG_LINE_TYPE_BIT, 0, 0, "Stone Glyph", (long *)&debugRazielFlags1,
     0x80000},
    {DEBUG_LINE_TYPE_BIT, 0, 0, "Force Glyph", (long *)&debugRazielFlags1,
     0x40000},
    {DEBUG_LINE_TYPE_BIT, 0, 0, "Sound Glyph", (long *)&debugRazielFlags1,
     0x100000},
    {DEBUG_LINE_TYPE_BIT, 0, 0, "Plane Shift Glyph", (long *)&debugRazielFlags1,
     0x01000000},
    {DEBUG_LINE_TYPE_ENDLIST, 0, 0, "", &gameTrackerX.debugFlags, 0},
};
DebugMenuLine debugImbueSoulReaverMenu[] = {
    {DEBUG_LINE_TYPE_MENU, 0, 0, "MAIN MENU...", (long *)standardMenu, 0},
    {DEBUG_LINE_TYPE_MENU, 0, 0, "RAZIEL MENU...", (long *)debugRazielMenu, 0},
    {DEBUG_LINE_TYPE_BIT, 0, 0, "Hold Soul Reaver", (long *)&debugRazielFlags1,
     8},
    {DEBUG_LINE_TYPE_BIT, 0, 0, "Spectral Reaver", (long *)&debugRazielFlags2,
     0x400},
    {DEBUG_LINE_TYPE_BIT, 0, 0, "Material Reaver", (long *)&debugRazielFlags2,
     0x800},
    {DEBUG_LINE_TYPE_BIT, 0, 0, "Fire Reaver", (long *)&debugRazielFlags2,
     0x8000},
    {DEBUG_LINE_TYPE_ENDLIST, 0, 0, "", &gameTrackerX.debugFlags, 0},
};
DebugMenuLine cheatsMenu[] = {
    ...
    {DEBUG_LINE_TYPE_BIT, 0, 0, "Activate All WarpGates",
     &gameTrackerX.streamFlags, 0x400000},
    {DEBUG_LINE_TYPE_BIT, 0, 0, "Disable Monsters Loading",
     &gameTrackerX.debugFlags2, 0x8000},
    {DEBUG_LINE_TYPE_BIT, 0, 0, "Skip First Puppet Show",
     &gameTrackerX.streamFlags, 0x800000},
    {DEBUG_LINE_TYPE_BIT, 0, 0, "Skip All Puppet Shows",
     &gameTrackerX.debugFlags2, 0x800000},
    {DEBUG_LINE_TYPE_BIT, 0, 0, "Show Warp Gate Info",
     &gameTrackerX.debugFlags2, 0x01000000},
...
DebugMenuLine cameraMenu[] = {
    {DEBUG_LINE_TYPE_MENU, 0, 0, "MAIN MENU...", (long *)standardMenu, 0},
    {DEBUG_LINE_TYPE_LONG, 0, 0x400, "Center Delay", (long *)&CameraCenterDelay,
     0},
    {DEBUG_LINE_TYPE_BIT, 0, 0, "Camera Override", &gameTrackerX.debugFlags2,
     0x02000000},
    {DEBUG_LINE_TYPE_ENDLIST, 0, 0, "", &gameTrackerX.debugFlags, 0},
};
DebugMenuLine AIMenu[] = {
    {DEBUG_LINE_TYPE_MENU, 0, 0, "MAIN MENU...", (long *)standardMenu, 0},
    {DEBUG_LINE_TYPE_BIT, 0, 0, "DISABLE MONSTER AI", &gameTrackerX.debugFlags2,
     8},
    {DEBUG_LINE_TYPE_BIT, 0, 0, "MONSTER STATS", &gameTrackerX.debugFlags2, 2},
    {DEBUG_LINE_TYPE_ACTION, 0, 0, "CINEMATIC SWITCH",
     (long *)DEBUG_SendCinematicSwitch, 0},
    {DEBUG_LINE_TYPE_ACTION, 0, 0, "SEND CINEMATIC COMMAND",
     (long *)DEBUG_SendMoveTo, 0},
    {DEBUG_LINE_TYPE_ENDLIST, 0, 0, "", &gameTrackerX.debugFlags, 0},
};
DebugMenuLine AlukaMenu[] = {
    ...
    {DEBUG_LINE_TYPE_ACTION, 0xC, 0, "ALUKA 12", (long *)DEBUG_LevelSelectNew,
     0},
    {DEBUG_LINE_TYPE_ACTION, 0x13, 0, "ALUKA 19", (long *)DEBUG_LevelSelectNew,
     0},
    {DEBUG_LINE_TYPE_ACTION, 0x1B, 0, "ALUKA 27", (long *)DEBUG_LevelSelectNew,
     0},
    {DEBUG_LINE_TYPE_ACTION, 0x1D, 0, "ALUKA 29", (long *)DEBUG_LevelSelectNew,
     0},
    {DEBUG_LINE_TYPE_ENDLIST, 0, 0, "", &gameTrackerX.debugFlags, 0},
};
...
DebugMenuLine OracleMenu[] = {
    ...
    {DEBUG_LINE_TYPE_ACTION, 0xA, 0, "ORACLE 10", (long *)DEBUG_LevelSelectNew,
     0},
    {DEBUG_LINE_TYPE_ACTION, 0xD, 0, "ORACLE 13", (long *)DEBUG_LevelSelectNew,
     0},
    {DEBUG_LINE_TYPE_ACTION, 0xF, 0, "ORACLE 15", (long *)DEBUG_LevelSelectNew,
     0},
    {DEBUG_LINE_TYPE_ACTION, 0x11, 0, "ORACLE 17", (long *)DEBUG_LevelSelectNew,
     0},
    {DEBUG_LINE_TYPE_ACTION, 0x12, 0, "ORACLE 18", (long *)DEBUG_LevelSelectNew,
     0},
    {DEBUG_LINE_TYPE_ACTION, 0x16, 0, "ORACLE 22", (long *)DEBUG_LevelSelectNew,
     0},
    {DEBUG_LINE_TYPE_ENDLIST, 0, 0, "", &gameTrackerX.debugFlags, 0},
};
DebugMenuLine PillarsMenu[] = {
    {DEBUG_LINE_TYPE_MENU, 0, 0, "AREA MENU...", (long *)levelSelectMenu, 0},
    {DEBUG_LINE_TYPE_ACTION, 3, 0, "Pillars 3", (long *)DEBUG_LevelSelectNew,
     0},
    {DEBUG_LINE_TYPE_ACTION, 4, 0, "Pillars 4", (long *)DEBUG_LevelSelectNew,
     0},
    {DEBUG_LINE_TYPE_ACTION, 9, 0, "Pillars 9", (long *)DEBUG_LevelSelectNew,
     0},
...
DebugMenuLine SilencedCathedralMenu[] = {
    ...
    {DEBUG_LINE_TYPE_ACTION, 0x13, 0, "Cathy 19", (long *)DEBUG_LevelSelectNew,
     0},
    {DEBUG_LINE_TYPE_ACTION, 0x2A, 0, "Cathy 42", (long *)DEBUG_LevelSelectNew,
     0},
    {DEBUG_LINE_TYPE_ACTION, 0x2F, 0, "Cathy 47", (long *)DEBUG_LevelSelectNew,
     0},
    {DEBUG_LINE_TYPE_ACTION, 0x31, 0, "Cathy 49", (long *)DEBUG_LevelSelectNew,
     0},
    {DEBUG_LINE_TYPE_ACTION, 0x44, 0, "Cathy 68", (long *)DEBUG_LevelSelectNew,
     0},
    {DEBUG_LINE_TYPE_ENDLIST, 0, 0, "", &gameTrackerX.debugFlags, 0},
};
...
DebugMenuLine StoneMenu[] = {
    ...
    {DEBUG_LINE_TYPE_ACTION, 0xA, 0, "STONE 10", (long *)DEBUG_LevelSelectNew,
     0},
    {DEBUG_LINE_TYPE_ENDLIST, 0, 0, "", &gameTrackerX.debugFlags, 0},
};
DebugMenuLine SunLightMenu[] = {
    ...
    {DEBUG_LINE_TYPE_ACTION, 1, 0, "INTVALY 1", (long *)DEBUG_LevelSelectNew,
     0},
...
DebugMenuLine TombMenu[] = {
    ...
    {DEBUG_LINE_TYPE_ACTION, 1, 0, "CONECTC 1", (long *)DEBUG_LevelSelectNew,
     0},
...
DebugMenuLine CityMenu[] = {
    ...
    {DEBUG_LINE_TYPE_ACTION, 0xE, 0, "CITY 14", (long *)DEBUG_LevelSelectNew,
     0},
    {DEBUG_LINE_TYPE_ENDLIST, 0, 0, "", &gameTrackerX.debugFlags, 0},
};
...
DebugMenuLine HubAMenu[] = {
    ...
    {DEBUG_LINE_TYPE_ACTION, 0xA, 0, "Huba 10", (long *)DEBUG_LevelSelectNew,
     0},
    {DEBUG_LINE_TYPE_ENDLIST, 0, 0, "", &gameTrackerX.debugFlags, 0},
};
...
DebugMenuLine AnteRoomsMenu[] = {
    ...
    {DEBUG_LINE_TYPE_ACTION, 0xC, 0, "Skinnr 12", (long *)DEBUG_LevelSelectNew,
     0},
    {DEBUG_LINE_TYPE_ACTION, 0x36, 0, "Cathy 54", (long *)DEBUG_LevelSelectNew,
     0},
    {DEBUG_LINE_TYPE_ACTION, 2, 0, "Pillars 2", (long *)DEBUG_LevelSelectNew,
     0},
    {DEBUG_LINE_TYPE_ACTION, 0x2E, 0, "Aluka 46", (long *)DEBUG_LevelSelectNew,
     0},
...
DebugMenuLine BossAreasMenu[] = {
    {DEBUG_LINE_TYPE_MENU, 0, 0, "More Areas Menu...", (long *)level2SelectMenu,
     0},
    {DEBUG_LINE_TYPE_MENU, 0, 0, "Anterooms...", (long *)AnteRoomsMenu, 0},
    {DEBUG_LINE_TYPE_ACTION, 9, 0, "Skinnr 9", (long *)DEBUG_LevelSelectNew, 0},
    {DEBUG_LINE_TYPE_ACTION, 0x37, 0, "Cathy 55", (long *)DEBUG_LevelSelectNew,
     0},
    {DEBUG_LINE_TYPE_ACTION, 1, 0, "Pillars 1", (long *)DEBUG_LevelSelectNew,
     0},
    {DEBUG_LINE_TYPE_ACTION, 6, 0, "Aluka 6", (long *)DEBUG_LevelSelectNew, 0},
    {DEBUG_LINE_TYPE_ACTION, 3, 0, "Nightb 3", (long *)DEBUG_LevelSelectNew, 0},
...
DebugMenuLine levelSelectMenu[] = {
    {DEBUG_LINE_TYPE_MENU, 0, 0, "MAIN MENU...", (long *)standardMenu, 0},
    {DEBUG_LINE_TYPE_ACTION, 0, 0, "RELOAD CURRENT LEVEL",
     (long *)DEBUG_ReloadCurrentLevel, 0},
    ...
    {DEBUG_LINE_TYPE_MENU, 0, 0, "Silenced Cathedral...",
     (long *)SilencedCathedralMenu, 0},
...
static long CheatKeyMap[10] = {4,    8,    2,     1,     0x10,
                               0x40, 0x80, 0xC00, 0x400, 0x800};
...
void DEBUG_SetGameTime(long *var) { GAMELOOP_SetGameTime(*var); }
...
void DEBUG_UpdateFog(long *var) {
  ...
  gameTrackerX.level->holdFogFar = currentUnit->TargetFogFar =
      gameTrackerX.level->fogFar = (unsigned short)debugFogFar;
  gameTrackerX.level->holdFogNear = currentUnit->TargetFogNear =
      gameTrackerX.level->fogNear = (unsigned short)debugFogNear;

  *(int *)&gameTrackerX.level->backColorR = currentUnit->FogColor =
      (debugFogBlu << 16) | (debugFogGrn << 8) | debugFogRed;
...
void DEBUG_SendMoveTo(void) {
  int posX =
      (gameTrackerX.playerInstance->position.x + (rand() & 0x7FF)) - 0x400;
  int posY =
      (gameTrackerX.playerInstance->position.y + (rand() & 0x7FF)) - 0x400;
  int posZ = gameTrackerX.playerInstance->position.z;
  INSTANCE_Broadcast(0, 0xE, 0x4000C, SetPositionData(posX, posY, posZ));
}
...
void DEBUG_SetViewVram() { gameTrackerX.gameMode = 7; }
